...
one-shot command that exits after each turn, it needs a resident bridge for
ongoing chat after bootstrap; the skill's Connection owner selection makes that
distinction.
